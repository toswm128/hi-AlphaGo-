...
(function (global, factory) {
  ...
  function avgPool3D(args) {
      ...
      const convInfo = tfjsCore.backend_util.computePool3DInfo(x.shape, filterSize, strides, $dilations, pad, dimRoundingMode, dataFormat);
      const xValues = backend.data.get(x.dataId).values;
  ...
  function avgPool3DGrad(args) {
      ...
      const convInfo = tfjsCore.backend_util.computePool3DInfo(input.shape, filterSize, strides, dilations, pad, dimRoundingMode);
      const strideDepth = convInfo.strideDepth;
      const strideHeight = convInfo.strideHeight;
      const strideWidth = convInfo.strideWidth;
